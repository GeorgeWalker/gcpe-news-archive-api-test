...
namespace Gov.News.Archive.Api
{
    ...
    */
        ...
        private static void ReportDocumentSendFailure(PerformContext hangfireContext, List<Gov.News.Archive.Api.Models.Archive> data)
        {
            hangfireContext.SetTextColor(ConsoleTextColor.Red);
            ...
            foreach (Gov.News.Archive.Api.Models.Archive item in data)
            {
